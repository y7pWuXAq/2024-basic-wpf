...
namespace ex11_Gimhea_FineDust.Models
{
    public class DustSensor
    {
        public int Id { get; set; } // 추가 생성, DB에 넣을 때 사용할 값
        ...
        public int Pm10_after { get; set; } // 10m 미세먼지 측정값
        public int Pm25_after { get; set; } // 25m 초미세먼지 측정값
